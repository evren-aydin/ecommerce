...
import {faArrowRightLong, faBars, faCartShopping, faMagnifyingGlass,faAngleRight} from '@fortawesome/free-solid-svg-icons';
    ...
    <div>
        ...
        <div className="w-full h-[384px] gap-3 flex flex-col items-center bg-cover sm:w-[414px] sm:h-[800px] sm:object-fit">
            ...
            <div className='w-[870px] h-[280px] flex justify-center items-center sm:w-[414px] sm:h-[200px] '>
                ...
                <h1 className='text-5xl font-bold sm:text-3xl' >Innovation tailored for you</h1>
        ...
        <div className='w-full h-[530px] flex flex-row justify-center gap-2 sm:flex-col sm:w-[413px] sm:h-[1070px]'>
            <div className='w-[700px] h-[530px] sm:w-full sm:h-[530px]'><img src={resim1} className='object-cover w-full h-full' alt="" /></div>
            
            <div className='w-[740px] h-[530px] flex flex-wrap gap-2 justify-center sm:grid sm:grid-cols-2 sm:w-full sm:h-[530px]'>
            <img src={resim2} className='w-[361px] h-[260px] sm:w-[204px] sm:h-[260px] object-cover' alt="" />
            <img src={resim3} className='w-[361px] h-[260px] sm:w-[204px] sm:h-[260px] object-cover' alt="" />
            <img src={resim4} className='w-[361px] h-[260px] sm:w-[204px] sm:h-[260px] object-cover' alt="" />
            <img src={resim5} className='w-[361px] h-[260px] sm:w-[204px] sm:h-[260px] object-cover' alt="" />
            </div>
        ...
        <div className='w-full h-[1759px] flex justify-center sm:w-[414px] sm:h-[4180px]'>
            <div className='h-full w-[1050px] flex flex-col items-center font-mont py-24 font-bold gap-28 sm:w-[361px] sm:h-full '>
                <h1 className='text-4xl sm:w-[250px] sm:text-center sm:text-5xl'>Meet Our Team</h1>
       ...
       <div className='w-full h-[442px] flex justify-center sm:w-[414px] sm:h-[586px]'>
        <div className='h-full w-[1050px] flex justify-center items-center sm:w-[332px] sm:h-full'>
            <div className='w-[607px] h-[282px] font-mont flex items-center flex-col justify-center text-center gap-8 sm:w-full sm:h-[352px]'>
                ...
                <p className='text-gray-500 w-[410px] sm:w-[332px] font-semibold text-sm'>Met minim Mollie non desert Alamo est sit cliquey dolor 
do met sent. RELIT official consequent.</p>
                    <button className='py-4 px-8 text-white bg-blue-400 rounded-md font-bold'>Try it free now</button>
