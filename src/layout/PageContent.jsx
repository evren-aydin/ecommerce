  ...
  return (
    ...
    <div className="w-full h-[770px] relative flex justify-center bg-[#fafafa]">
      ...
      <div className="static h-full w-[1050px] flex flex-col items-center justify-center gap-11">
        ...
        <div className="div1 w-[510px] h-full  relative">
        <img src={filter1} alt=""  className="object-contain"/>
        <button className="font-bold bg-white px-14 py-2 absolute bottom-5 left-5">MEN</button>
        </div>
        <div className="div2 w-[240px] h-full relative">
        ...
        <div className="div3 w-[240px] h-full  flex flex-col gap-4">
