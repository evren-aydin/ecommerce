      ...
      <div className='sm:w-[414px] sm:h-[532px] sm:flex  sm:flex-col sm:items-center sm:gap-20'>
        <div className='sm:h-[60px] sm:w-[414px] sm:flex sm:flex-row sm:justify-around sm:items-center sm:pt-10'>
          ...
          <div className='sm:flex sm:flex-row sm:gap-5'>
             <a className='hidden cursor-pointer sm:block sm:text-xl'><FontAwesomeIcon icon={faMagnifyingGlass}  /></a>
      ...
      <div className="relative w-full h-full bg-cover" style={{backgroundImage: `url(${slides[currentIndex].url})`}}>
        ...
        <div className="absolute top-0 left-0 w-full h-full flex justify-center sm:items-center">
          <div className=" w-[1044px] h-[651px] flex items-center mr-80 md:mr-0">
            ...
            <h2 className=" font-semibold text-white text-xl">SUMMER 2020</h2>
            <h1 className="text-white text-7xl font-bold sm:text-5xl">NEW COLLECTION</h1>
            <p className="text-white w-[330px] h-[60px] text-xl">We know how large object will act. but things on a small scale.</p>
            <button className="bg-[#2dc071] text-white font-semibold text-xl p-3 w-[221px] rounded">SHOP NOW</button></div>
          </div>
        </div>
        {/* Slider Navigasyonu */}
